 ...
 */
template<typename U>
rat_dict<typename U::value_type> calculate_rat(OpticStack<U> *stack, U &&wavelength, const double angle,
                                               const char pol, const bool coherent,
...
template rat_dict<double> calculate_rat(OpticStack<QList<double>> *stack, QList<double> &&wavelength,
                                        const double angle, const char pol, const bool coherent,
                                        const std::vector<char> &coherency_list);
